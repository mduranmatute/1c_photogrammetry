%% #######################################################################%
%------------ MATLAB Script used to calibrate camera position ------------%
%#########################################################################%
% This is an example script used for the camera calibration. For a
...
% See directory (Examples\Calibration) for a camera calibration example.
% Files, image directories, and values necessary are included in examples.
...
% This grid and position of the dots is specifically used in the
% study. This is changed depending on the calibration grid used, see
% [Common_Functions/calibration_plate_grid.m].
